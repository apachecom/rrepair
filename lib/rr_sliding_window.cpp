...
template <>
void parse::init<uint64_t,w_kr_uc32>( const uint32_t & size,w_kr_uc32& );
...
template <>
void parse::destroy<w_kr_uc32>( w_kr_uc32& window){
    delete[] window.window;
}


template <>
void parse::init<uint64_t,w_kr_uc32>( const uint32_t & size, w_kr_uc32& window){
...
template <>
uint64_t parse::feed<unsigned char,w_kr_uc32>( const unsigned char& c, w_kr_uc32& window){
...
template <>
void parse::reset<w_kr_uc32>(  w_kr_uc32& windows ){
...
template <>
uint64_t parse::size_window<w_kr_uc32>( w_kr_uc32& windows){
