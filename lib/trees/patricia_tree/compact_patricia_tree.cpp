...
#include "../../../include/trees/patricia_tree/compact_patricia_tree.h"

using namespace trees;
using namespace util;

compact_patricia_tree::compact_patricia_tree() = default;

compact_patricia_tree::~compact_patricia_tree() = default;

void compact_patricia_tree::build(const compact_patricia_tree::T &tree) {
    ...
    tree.dfs(tree.root(),[&_jumps,&_s,&b_temp,&pre_s,&pre, &off](const node *n, const char &a, const ulong &j)->bool
    {
...
void compact_patricia_tree::build(const patricia_tree<util::string_pairs_suffix> &tree) {
...
compact_patricia_tree::ulong  compact_patricia_tree::node_match(const  compact_patricia_tree::K &str) const {
    ulong node =  compact_patricia_tree::tree::root();
    compact_patricia_tree::ulong p = 0;
    path(node,str,p);
    return node;
}

compact_patricia_tree::ulong  compact_patricia_tree::node_match(const  compact_patricia_tree::revK &str) const {
    ulong node =  compact_patricia_tree::tree::root();
    compact_patricia_tree::ulong p = 0;
    path(node,str,p);
    return node;
...
compact_patricia_tree::ulong  compact_patricia_tree::node_locus(const  compact_patricia_tree::K & str, const compact_patricia_tree::ulong & limit, compact_patricia_tree::ulong& pos_locus)const {
    compact_patricia_tree::ulong node =  compact_patricia_tree::tree::root();
    pos_locus = 0;
    path(node,str,pos_locus,limit);
    return node;
}
compact_patricia_tree::ulong  compact_patricia_tree::node_locus(const  compact_patricia_tree::revK & str, const compact_patricia_tree::ulong & limit, compact_patricia_tree::ulong& pos_locus)const
{
    compact_patricia_tree::ulong node =  compact_patricia_tree::tree::root();
    pos_locus = 0;
    path(node,str,pos_locus,limit);
...
void  compact_patricia_tree::save(std::fstream & f) const {
...
bool  compact_patricia_tree::path(compact_patricia_tree::ulong & node, const  compact_patricia_tree::K &str,
...
bool  compact_patricia_tree::path(compact_patricia_tree::ulong & node, const  compact_patricia_tree::revK &str,
                                             compact_patricia_tree::ulong & p) const{
...
void  compact_patricia_tree::path(compact_patricia_tree::ulong & node, const  compact_patricia_tree::K & str, compact_patricia_tree::ulong & p, const compact_patricia_tree::ulong &limit) const{
...
void  compact_patricia_tree::path(compact_patricia_tree::ulong & node, const  compact_patricia_tree::revK & str, compact_patricia_tree::ulong & p, const compact_patricia_tree::ulong &limit) const{
...
void  compact_patricia_tree::load(std::fstream &f) {
...
const  compact_patricia_tree::tree & compact_patricia_tree::get_tree() const {
    return m_tree;
}

compact_patricia_tree::ulong  compact_patricia_tree::size_in_bytes() const {

    return m_tree.size_in_bytes() + sdsl::size_in_bytes(jumps) + sdsl::size_in_bytes(seq);

}

void  compact_patricia_tree::print_size_in_bytes() const {
...
compact_patricia_tree &compact_patricia_tree::operator=(const  compact_patricia_tree& T) = default;
