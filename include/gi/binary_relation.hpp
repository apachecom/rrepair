...
//        typedef sdsl::vlc_vector<> compressed_seq;
        ...
        void range(binary_relation::bin_long &, binary_relation::bin_long &, binary_relation::bin_long &,
                   binary_relation::bin_long &, std::vector<std::pair<size_t, size_t>> &);

        void range2(binary_relation::bin_long &, binary_relation::bin_long &, binary_relation::bin_long &,
                    binary_relation::bin_long &, std::vector<std::pair<size_t, size_t>> &);
        ...
        auto get_XB_size() const {
            return sdsl::size_in_bytes(XB) +
